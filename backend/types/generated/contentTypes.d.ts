...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog articles for the knowledge base.';
    displayName: 'Article';
    pluralName: 'articles';
  ...
  attributes: {
    ...
    author_image_url: Schema.Attribute.String;
    ...
    featured_image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
...
export interface ApiGlobalSettingGlobalSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'General settings for the landing page';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ects: Schema.Attribute.String & Schema.Attribute.DefaultTo<'60 ECTS'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    recruitment_link: Schema.Attribute.String;
    semester_count: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'2 semestry'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiLecturerLecturer extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Faculty members and experts.';
...
export interface ApiModuleModule extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Program modules like Strategy, Technology, etc.';
    displayName: 'Module';
    pluralName: 'modules';
    singularName: 'module';
  };
